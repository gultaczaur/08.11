...
// const getData = () => {
//      let newData = users.filter((item)=>item.height>150)
//      console.log(newData);
// }
// getData()
...
//     let detail = users.find((item) => item.firstName==name)
//     console.log(detail);
// }
// getDetail("Addison")
...
// const age = () => {
//     let sum = users.reduce((total, item) => total + item.age, 0)
...
// const title = () => {
//     users.map((item) => item.company.title == "Web Developer" ? console.log(item) : null)
// }
// title()
